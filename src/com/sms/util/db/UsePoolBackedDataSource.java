/*
 * Distributed as part of c3p0 0.9.5-pre7
 *
...
public final class UsePoolBackedDataSource
{
	...
	try
		...
		DataSource unpooled = DataSources.unpooledDataSource("jdbc:mysql://localhost:3306/ecshop",
			     "root",
			     "feiyuntang");
		...
		try
			...
			rs = stmt.executeQuery("SELECT * FROM ecs_users");
			while (rs.next())
